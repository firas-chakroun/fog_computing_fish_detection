...
def home():
    if request.method == 'POST':
        ...
        if file:
            ...
            # Generate a unique filename for the received image
            unique_filename1 = str(uuid.uuid4()) + '1.jpg'
            unique_filename2 = str(uuid.uuid4()) + '2.jpg'
            received_filename1 = os.path.join(RECEIVED_FOLDER, unique_filename1)
            received_filename2 = os.path.join(RECEIVED_FOLDER, unique_filename2)
            os.rename("received_image1.jpg", received_filename1)
            os.rename("received_image2.jpg", received_filename2)
